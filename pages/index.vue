      ...
      <div class="swiper-wrapper">
          ...
          <div v-for="banner in bannerList" :key="banner.id" class="swiper-slide" style="background: #040B1B;">
              <a target="_blank" :href="banner.linkUrl">
                  <img :src="banner.imageUrl" :alt="banner.title" style="">
              </a>
          </div>
      </div>
                  ...
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      ...
                      <span class="fl jgAttr c-ccc f-fA">
                        ...
                        |
                        <i class="c-999 f-fA">{{course.viewCount}}播放量</i>
                      </span>
                    </section>
                  </div>
                </li>
...
export default {
  ...
  methods:{
    ...
    //获取首页课程和老师
    getFrontInfo(){
      index.getFrontInfo().then(response=>{
        this.courseList = response.data.data.hotCourse
        this.teacherList = response.data.data.bestTeacher
      })
    }
  }
}
